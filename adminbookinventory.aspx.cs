...
namespace WebApplication1
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('No book exist with this id');</script>");
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (checkBookExist())
                {
                    Response.Write("<script>alert('book already exists with this ID');</script>");
                }
                else
                {
                    addBook();
        ...
        void updateBook()
        {
            if (checkBookExist())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl SET " +
                        ...
                        "edition=@edition, book_cost=@book_cost, no_of_pages=@no_of_pages, actual_stock=@actual_stock, " +
                    ...
                    con.Close();
                    GridView1.DataBind();
                    Response.Write("<script>alert('Book Data Updated Succesfuly');</script>");
                }
                catch (Exception ex)
                {
                    Response.Write("<script>alert('" + ex.Message + "');<script>");
            ...
            {
                Response.Write("<script>alert('Book Doesnt exist with this Id');</script>");
            }
        }
        // delete button
